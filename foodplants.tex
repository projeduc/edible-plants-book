...
%  };
  ...
  \node[anchor=north west,minimum width=17.7cm] at (-0.14cm,-3.6cm) {\includegraphics[width=17.7cm]{cover1.jpg}}; 
...
%  
%  \node[anchor=north west,minimum width=18.3cm,minimum height=24cm] (RB) at ([shift={(2.7cm,8cm)}]RB.south west) {\includegraphics[width=18.18cm]{cover1.jpg}}; 
...
%\begin{tikzpicture}
%\node[above right] (img) at (0,0) {\includegraphics[width=1.00\textwidth]{cover.jpg}};
