...
\begin{element}
\setimg{herbs/parsly.jpg}{Forest \& Kim Starr}{CC-BY-3}
\artxt{بقدونس}
\japtxt{パセリ}
\engtxt{Parsley}
\frtxt{Persil}
...
\begin{element}
\setimg{leafySalad-veg/arugula.jpg}{Leo Michels}{public}
\artxt{جرجير}
\japtxt{ルッコラ}
...
\begin{element}
\setimg{leafySalad-veg/beetroot.jpg}{Siebrand}{CC-BY-SA-2}
\artxt{شمندر}
\japtxt{テーブルビート}
\engtxt{Beetroot}
\frtxt{Betterave}
