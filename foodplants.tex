...
\begin{element}
\setimg{}{Andrew Butko}{CC-BY-SA-3}
\artxt{فاصولياء}
\japtxt{いんげん豆(まめ)}
\engtxt{Bean}
\frtxt{Haricot}
...
\begin{element}
\setimg{}{André\'e Karwath}{CC-BY-SA-2.5}
\artxt{فلفل حريف}
\japtxt{カイエンペッパー}
...
\begin{element}
\setimg{}{ZooFari + Bierfaß}{Public + CC-BY-SA-3}
\artxt{كزبرة}
\japtxt{コリアンダー}
\engtxt{Coriander}
\frtxt{Coriandre}
...
\begin{element}
\setimg{}{Antti V\"ah\"a-Sipil\"a}{CC-BY-SA-1fi}
\artxt{قرفة}
\japtxt{シナモン}
\engtxt{Cinnamon}
\frtxt{Cannelle}
...
\begin{element}
\setimg{}{Arto Alanenp\"a\"a}{CC-BY-SA-3}
\artxt{شبت}
\japtxt{イノンド}
\engtxt{Dill}
\frtxt{Aneth}
...
\begin{element}
\setimg{}{Frank C. M\"uller}{CC-BY-SA-3}
\artxt{زنجبيل}
\japtxt{生姜(しょうが)}
\engtxt{Ginger}
\frtxt{Gingembre}
...
\begin{element}
\setimg{}{H. Zell}{CC-BY-SA-3}
\artxt{رعي الحمام الليمون}
\japtxt{レモンバーベナ}
...
\begin{element}
\setimg{}{Pamla J. Eisenberg}{CC-BY-SA-2}
\artxt{حبة البركة}
\japtxt{ニゲラ}
\engtxt{Nigella}
\frtxt{Nigelle}
...
\begin{element}
\setimg{}{Forest \& Kim Starr}{CC-BY-3}
\artxt{بقدونس}
\japtxt{パセリ}
\engtxt{Parsley}
\frtxt{Persil}
...
\begin{element}
\setimg{}{Devadaskrishnan}{CC-BY-3}
\artxt{فلفل أسود}
\japtxt{こしょう}
\engtxt{Black pepper}
\frtxt{Poivre}
